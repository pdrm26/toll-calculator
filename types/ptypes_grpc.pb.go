...
type AggregatorClient interface {
	Aggregate(ctx context.Context, in *AggregatorDistance, opts ...grpc.CallOption) (*None, error)
}
...
func (c *aggregatorClient) Aggregate(ctx context.Context, in *AggregatorDistance, opts ...grpc.CallOption) (*None, error) {
...
type AggregatorServer interface {
	Aggregate(context.Context, *AggregatorDistance) (*None, error)
...
func (UnimplementedAggregatorServer) Aggregate(context.Context, *AggregatorDistance) (*None, error) {
...
func _Aggregator_Aggregate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorServer).Aggregate(ctx, req.(*AggregatorDistance))
	}
